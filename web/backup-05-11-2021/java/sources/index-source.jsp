<div class="job_details_area" id="java_div">
    <div class="container">
        <div class="apply_job_form white-bg" style="margin-right: auto; margin-left: auto;" id="remove_paddings_code">
            <h4 style="font-size: 38px; font-weight: 400; text-align: center" class="wow fadeInLeft"
                ...
                <a class="index_title_links" href="${pageContext.request.contextPath}/java/">ScrypJava</a></h4>
            <h5 style="color: #00D363; text-align: center" class="wow fadeInRight" data-wow-duration="1s"
                data-wow-delay=".15s">ScrypJava - онлайн-компилятор, позволяющий программировать на языке Java прямо
                в вашем браузере.</h5>
            <form method="POST" autocomplete="on" id="java_form" action="javascript:void(0);">
                <div class="col-md-5 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".35s"
                    ...
                    <button class="buttons" id="run_java_code" title="Ctrl+F10"
                ...
                <div class="col-md-12 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s"
                    ...
                    <div class="mein-labels" style="float: left">Код (Java code)</div>
...
<script>
    ...
    editor_input.setValue("public class Main {\n" +
        "  public static void main(String[] args) {\n" +
        "    System.out.println(\"Hello World\");\n" +
        "  }\n" +
        "}")
    $("#run_java_code").on("click", function (e) {
        startInterpreting()
    })
