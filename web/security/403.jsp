                            ...
                            <div class="row">
                                ...
                                <article class="blog_item col-md-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".15s">
                                    <div class="blog_item_img">
                                        <div style="width: 300px; height: 300px; margin-right: auto; margin-left: auto"> <img class="card-img rounded-0" src="${pageContext.request.contextPath}/vectors/access-denied.svg" width="300" height="300" alt="access-denied"></div>
                                    </div>
